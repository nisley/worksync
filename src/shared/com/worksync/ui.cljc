(ns com.worksync.ui
  (:require
    ...
    [com.worksync.ui.account-forms :refer [AccountForm AccountList]]
    [com.worksync.ui.invoice-forms :refer [InvoiceForm InvoiceList AccountInvoices]]
    [com.worksync.ui.item-forms :refer [ItemForm InventoryReport]]
    [com.worksync.ui.assignee-forms :refer [AssigneeReport]]
    [com.worksync.ui.list-forms :refer [ListReport ListForm]]
    [com.worksync.ui.login-dialog :refer [LoginForm]]
    [com.worksync.ui.sales-report :as sales-report]
    [com.worksync.ui.dashboard :as dashboard]
...
(defrouter MainRouter [this {:keys [current-state route-factory route-props]}]
  {:always-render-body? true
   :router-targets      [LandingPage ItemForm InvoiceForm InvoiceList AccountList AccountForm AccountInvoices
                         ...
                         AssigneeReport ListReport ListForm
        ...
        (when logged-in?
          #?(:cljs
             (comp/fragment
               ...
               (ui-dropdown {:className "item" :text "Assignee"}
                            (ui-dropdown-menu {}
                                              (ui-dropdown-item {:onClick (fn [] (rroute/route-to! this AssigneeReport {}))} "View All")))
               (ui-dropdown {:className "item" :text "Lists"}
                            (ui-dropdown-menu {}
                                              (ui-dropdown-item {:onClick (fn [] (rroute/route-to! this ListReport {}))} "View All")
                                              (ui-dropdown-item {:onClick (fn [] (form/create! this ListForm))} "New")))
